...
| /wallet               | post   | Creates a new wallet, login required                                             | {<br>balance: number,<br>currency: string,<br> user_id:string<br>} | HTTP: 201 CREATED<br>{[wallet:{<br>_id:string,<br>balance: number,<br>currency: string,<br>user_id:string,<br>},user:{<br>_id:string,<br>email: string,<br>names: string,<br>role:string,<br>status:string<br>}]}                                                                                                                                       |
...
| /wallet/userid_currency                | get    | Returns user wallet by user_id and currency , login required, {userId, currency} query params |                                                                   | HTTP: 200 OK<br>\[wallet:{<br>_id:string,<br>balance: number,<br>currency: string,<br>user_id:string,<br>},user:{<br>_id:string,<br>email: string,<br>names: string,<br>role:string,<br>status:string<br>}]        |
